...
<header class="topbar"><a class="brand" href="/dashboard.php">NyanHours</a><nav class="actions"><a class="button-secondary" href="/timesheet.php">Planilla semanal</a><?php if($user['role']==='admin'):?><a class="button-secondary" href="/admin/">Administración</a><?php endif; ?></nav></header>
