(() => {
    const en = {
        ...
        'Tiempo acumulado por persona y cliente.':'Accumulated time by person and client.','Tiempo acumulado por cliente, usuario y actividad.':'Accumulated time by client, user, and activity.','Total de todo el equipo':'Entire team total','Todavía no hay horas registradas':'No hours have been recorded yet','Los registros del equipo aparecerán aquí.':'Team entries will appear here.','Subtotal:':'Subtotal:','Sin actividad':'No activity','Editar actividad':'Edit activity','Actividad':'Activity','Guardar':'Save','Exportar':'Export','Método no permitido.':'Method not allowed.'
    };
