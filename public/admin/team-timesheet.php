...
<?php foreach($users as $teamUser):?><tr data-client-row><td class="client-column"><strong><?=e($teamUser['name'])?></strong><small><?=e($teamUser['role']==='admin'?'ADMIN':'OPERADOR')?><?=!(bool)$teamUser['active']?' · Inactivo':''?></small></td>
