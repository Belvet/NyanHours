...
<div class="timesheet-heading"><div><h1>Planilla de equipo</h1><p class="muted">Revisá y editá las horas de todo el equipo por cliente.</p></div><?php if($selectedClient !== null):?><div class="week-nav"><a href="?<?=e(http_build_query(['client_id'=>$clientId,'week'=>$weekStart->modify('-7 days')->format('Y-m-d')]))?>">‹</a><span><time datetime="<?=e($weekStart->format('Y-m-d'))?>" data-local-date="<?=e($weekStart->format('Y-m-d'))?>"><?=e($weekStart->format('d/m/Y'))?></time> – <time datetime="<?=e($weekEnd->format('Y-m-d'))?>" data-local-date="<?=e($weekEnd->format('Y-m-d'))?>"><?=e($weekEnd->format('d/m/Y'))?></time></span><a href="?<?=e(http_build_query(['client_id'=>$clientId,'week'=>$weekStart->modify('+7 days')->format('Y-m-d')]))?>">›</a></div><?php endif;?></div>
