...
<div class="stats finance-stats"><div class="stat"><strong><?=e($money($passiveTotals['cost']))?></strong><span>Costo del equipo</span></div><div class="stat profit-stat <?=$passiveTotals['profit']<0?'is-negative':''?>"><strong><?=e($money($passiveTotals['profit']))?></strong><span>Ganancia pasiva</span></div><div class="stat profit-stat"><strong><?=e($money($ownerTotals['billed']))?></strong><span>Trabajo del OWNER</span></div><div class="stat total-earned-stat <?=$totalEarned<0?'is-negative':''?>"><strong><?=e($money($totalEarned))?></strong><span>Ganancia total del OWNER</span><small>Ganancia pasiva + trabajo propio</small></div></div>
